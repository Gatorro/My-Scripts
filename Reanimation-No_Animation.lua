--[[ Script not made by me: REDACTED]]
------------------
------------------
-- [[ Variables ]]
...
CFLoop = RunService.Heartbeat:Connect(function()
    ...
    if R6 then
        cf(Character:WaitForChild("Torso"),rig:WaitForChild("Torso"))
        cf(Character:WaitForChild("Left Arm"),rig:WaitForChild("Left Arm"))
        cf(Character:WaitForChild("Right Arm"),rig:WaitForChild("Right Arm"))
        cf(Character:WaitForChild("Left Leg"),rig:WaitForChild("Left Leg"))
        cf(Character:WaitForChild("Right Leg"),rig:WaitForChild("Right Leg"))
    else
